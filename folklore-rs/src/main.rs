//! folklore-bench — BEIR benchmark runner (CLI entry).
//!
...
use folklore_bench::application::{run_benchmark, BenchmarkConfig, BenchmarkReport};
use folklore_bench::domain::{beir::load_beir, BeirDataset, EncoderSpec};
use folklore_bench::infrastructure::{
...
fn print_banner(cli: &CliArgs, spec: &EncoderSpec, data_dir: &std::path::Path) {
    println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    println!(
        " folklore-bench (Rust/functional/DDD) — BEIR {}",
...
fn main() -> Result<()> {
    ...
    let bench_root = PathBuf::from(&home).join(".folklore/bench");
