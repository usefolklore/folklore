...
<task type="auto" tdd="false">
  ...
  <behavior>
    ...
    - Grammar loading uses `createRequire(import.meta.url)` because tree-sitter is a CommonJS package and folklore is `"type": "module"` — document this in a comment block
