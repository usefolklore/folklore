...
The graph (folklore search) was probed for prior art on each idea: no local research notes or indexed papers cover **whitening, optimal-transport ranking, isotonic-RRF, conformal pruning, or PRF/Rocchio in the v4 hybrid path**. These are net-new attack vectors for this codebase.
