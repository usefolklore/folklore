...
patterns-established:
  ...
  - "Protocol-version negotiation at the envelope layer (not via libp2p protocol-path versioning). The libp2p protocol-path stays /wellinformed/share/1.0.0; V5 is enforced via `protocol_version: 5` in the SubscribeRequest JSON envelope. Pre-V5 peers receive a clear refusal payload."
