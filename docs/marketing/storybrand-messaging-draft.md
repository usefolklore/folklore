...
- New topic to dig into → query the Folklore, see what
...
> touched before. Folklore checks your local peer, then asks the
...
"Folklore" (stylised without the "c") gives us:
...
- **The Folklore. A federated record for the open-source community.**
- **Folklore — every contributor's reading, compounding into the community's progress.**
- **Folklore — open source's knowledge stack. P2P, signed, contributor-owned.**
- **Folklore — read the record the community already wrote.**
- **Folklore — each peer holds what it's asked for. Every query compounds the network.**
...
> When you ask Folklore something, it checks your peer first.
...
| | Pass 1 — Personal | Pass 2 — Small teams | Pass 3 — OSS community (Folklore) |
|---|---|---|---|
