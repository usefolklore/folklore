# Folklore — imagegen / frontend-web visual direction

Per-section art direction produced by applying `imagegen-frontend-web`
(from leonxlnx/taste-skill) to Folklore's redesign. Pairs with:
...
Folklore's "premium SaaS / infra / product" brief:
...
Brief mapping (per skill §1.5): Folklore = **SaaS / infra /
...
| Category | Pick | Why this for Folklore |
|----------|------|---------------------------|
...
```
┌──────────────────────────────────────────────────────────────────────────┐
│  ●  Folklore                     Demo · How · Bench · Install     ☆ Star  │
├──────────────────────────────────────────────────────────────────────────┤
│                                                                           │
...
│              The only difference is Folklore.                              │
│                                                                           │
│         ┌────────────────────────────────────────────────────┐           │
│         │                                                    │           │
│         │     scene-claude.gif                               │           │
│         │     (Claude alone vs Claude + Folklore,             │           │
...
> Folklore." Center: a single horizontal animated terminal
...
> (~14 s). The right terminal injects context from an Folklore
...
> showing "claude mcp add --scope user folklore -- folklore
> mcp" followed by "folklore claude install"; below that, a
...
│                                                          │  on BEIR       │
│  BEIR SciFact NDCG@10 — Folklore vs incumbents            │  SciFact       │
│                                                          │                │
│  Folklore            ████████████████████████  75.22%     │  vs the next   │
...
> SciFact NDCG@10 — Folklore vs incumbents". Below: a
> horizontal bar chart with 5 rows (Folklore, Pinecone-baseline,
> mem0-cached, Letta-default, LangChain-RAG); each row is a label
> in mono left-aligned, followed by a horizontal bar — Folklore
...
│  ┌──────────┐                                                             │
│  │ CH. 02   │                                                             │
│  │ THE      │   Folklore is not on the treadmill.                          │
...
│   ─────────────────────────────────────────────────────────────────────   │
│                                                                           │
│   Folklore adds: federation, peer reputation, signed envelopes.           │
└──────────────────────────────────────────────────────────────────────────┘
```
...
> label: a tight Outfit 600 H2 "Folklore is not on the
...
> "Folklore adds: federation, peer reputation, signed
...
│  (Napster→eMule→BitTorrent→IPFS→Folklore timeline, dimmed)                 │
│                                                                           │
│                                                                           │
│                                                                           │
│                                                                           │
...
> "BitTorrent 2001", "IPFS 2014", and "Folklore 2026" connected
...
│              ago. Folklore open-sources the knowledge graph               │
│              itself.                                                      │
│                                                                           │
...
This skill normally produces raster image-gen prompts. Folklore's
