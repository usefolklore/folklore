...
6. **F3** broaden secret-redaction patterns — OPEN; **H-2** reconsider public-DHT default-on — OPEN; **F2** shell-JSON hook — ✅ FIXED (node JSON.stringify); **F5** pin hook engine path — OPEN
