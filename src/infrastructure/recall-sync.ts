 ...
 *
 * Sibling protocol to /folklore/search/1.0.0. The architectural
 ...
 *     decisions later.
 *   - Mirrors how /folklore/touch/1.0.0 sits next to /search.
 *
 * Privacy boundary (V5):
...
export const RECALL_PROTOCOL_ID = '/folklore/recall/1.0.0' as const;
