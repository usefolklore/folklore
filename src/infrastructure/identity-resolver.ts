 ...
 *
 * Round-2 architecture-review priority #5: pair `WELLINFORMED_REQUIRE_SIGNED_NODES`
 ...
 *   list     — snapshot of every DID seen; used by `wellinformed
 ...
 * commit lifts state to `~/.wellinformed/identity-audit.json` with
